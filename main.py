...
class TextIn(BaseModel):
  J1_2ndWon: conint(ge=0, le=60, strict=True) = Field(...,)
  J1_ace: conint(ge=0, le=30, strict=True) = Field(...,)
  J1_bpFaced:  conint(ge=0, le=30, strict=True) = Field(...,)
  J1_df:  conint(ge=0, le=20, strict=True) = Field(...,)
  J1_age:  conint(ge=15, le=40, strict=True) = Field(...,)
  J1_ht:  conint(ge=150, le=220, strict=True) = Field(...,)
  J1_rank:  conint(ge=1, le=100, strict=True) = Field(...,)
  J2_2ndWon:  conint(ge=0, le=60, strict=True) = Field(...,)
  J2_ace:  conint(ge=0, le=30, strict=True) = Field(...,)
  J2_bpFaced:  conint(ge=0, le=30, strict=True) = Field(...,)
  J2_df:conint(ge=0, le=20, strict=True) = Field(...,)
  J2_age: conint(ge=15, le=40, strict=True) = Field(...,)
  J2_ht:  conint(ge=150, le=220, strict=True) = Field(...,)
